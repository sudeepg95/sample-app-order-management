...
export default function App() {
  ...
  const handleExceptionSubmit = (data: { type: ExceptionType; notes: string }) => {
      ...
      {currentScreen === 'dispatch' && (
        <div className="flex-1 flex flex-col items-center justify-center p-8 relative">
          <div className="flex flex-col items-center justify-center gap-12 w-full max-w-4xl border-4 border-pitch-black bg-white p-16 shadow-[12px_12px_0px_0px_rgba(3,7,18,1)]">
            <h1 className="font-headline text-7xl font-black uppercase">DISPATCH READY</h1>
            <p className="font-mono text-xl opacity-60 font-bold uppercase tracking-widest leading-none">ORDER #{order.id} CLEARED</p>
            <button
